...
set_target_properties(opencv_hdf PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_hdf.so.4.8.0"
  IMPORTED_SONAME_RELEASE "libopencv_hdf.so.408"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_hdf )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_hdf "${_IMPORT_PREFIX}/lib/libopencv_hdf.so.4.8.0" )
...
set_target_properties(opencv_viz PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_viz.so.4.8.0"
  IMPORTED_SONAME_RELEASE "libopencv_viz.so.408"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_viz )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_viz "${_IMPORT_PREFIX}/lib/libopencv_viz.so.4.8.0" )
...
set_target_properties(opencv_alphamat PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_alphamat.so.4.8.0"
  IMPORTED_SONAME_RELEASE "libopencv_alphamat.so.408"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_alphamat )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_alphamat "${_IMPORT_PREFIX}/lib/libopencv_alphamat.so.4.8.0" )
